/// <reference path="../Directive/lang-picker.html" />
...
(function (window, angular) {
    angular
      .module('k8LanguagePicker', ['ui.bootstrap', 'coffeeStoreApp'])
      .constant('langMap', window.languageMappingList)
      .directive('langPicker', [
        '$modal',
        'langMap',
        'translationfactory',
        function ($modal, langMap, translationfactory) {
            return {
                restrict: 'AE',
                transclude: true,
                scope: {
                ...
                replace: true,
                templateUrl: 'Directive/lang-picker-button.html',
                link: function (scope, el, attrs, ctrl) {
                    scope.open = function () {
                        $modal.open({
                            templateUrl: 'Directive/lang-picker.html',
                            controller: function ($scope, $modalInstance) {
                                ...
                                $scope.langInfo = $scope.supportedLanguages.map(function (lang) {
                                    return translationfactory.getLanguageTranslatedValue(lang);
                                });
                                console.log($scope.langInfo);
